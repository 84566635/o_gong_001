...
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2013-02-01  wml     正式发布
*		V1.1    2013-06-29  wml    增加1个读指针，用于bsp_Idle() 函数读取系统控制组合键（截屏）
...
*/
	...
	/*
		   按键口线分配：
			...
			摇杆OK键   : PA1  (低电平表示按下)
	*/
	#define RCC_ALL_KEY 	(RCC_APB2Periph_GPIOC)	/* 按键口对应的RCC时钟 */
...
static void bsp_InitKeyHard(void)
{
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD;		/* 设为输入口 */
